...
<html>
  <head>
    ...
    <script type="text/javascript" src="../qlcangca/lib/jquery.min.js"></script>
      ...
      <link rel="stylesheet" type="text/css" href="../qlcangca/lib/themes/mobile.css">
      ...
      <script type="text/javascript" src="../qlcangca/lib/jquery.easyui.mobile.js"></script>
  <style>
...
<body>
<h1>TRUY CẬP KHÔNG THÀNH CÔNG</h1>
<h2>Vui lòng liên hệ với ADMIN quản lý tại đơn vị</h2>
