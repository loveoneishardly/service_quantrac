    ...
    <div id="wrapper">
      <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
        ...
        <ul class="sidebar-menu do-nicescrol">
          <li>
            <a href="go?page=_index_manage&subP=history_data">
              <i class="zmdi zmdi-view-dashboard"></i> <span>Lịch sử nhận dữ liệu</span>
            </a>
          </li>
          <li>
            <a href="go?page=_index_manage&subP=category_station">
              <i class="zmdi zmdi-view-dashboard"></i> <span>Danh mục tram quan trắc</span>
            </a>
          </li>
          <li>
            <a href="go?page=_index_manage&subP=category_data">
              <i class="zmdi zmdi-view-dashboard"></i> <span>Danh mục dữ liệu</span>
            </a>
          </li>
          <li>
            <a href="go?page=_index_manage&subP=category_user">
            ...
            <li class="nav-item">
              ...
              <li class="dropdown-item user-details">
                ...
                <li class="dropdown-item"><i class="icon-power mr-2"></i> 
                  <a href="javascript:void(0);" onclick="xacnhandangxuat();">Thoát</a>
                </li>
              </ul>
            </li>
          </ul>
